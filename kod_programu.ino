...
#include<Wire.h>
//należy dodać adres lcd i2c, użyj pliku i2c-scanner.ino
LiquidCrystal_I2C lcd(0x27, 16, 2);
//--------------------------------------------------------------
//numer na który będą przychodzić powiadomienia o wypadku
const String EMERGENCY_PHONE = "NUMER ALARMOWY";
//--------------------------------------------------------------
    ...
    //--------------------------------------------------------------
      ...
      if(buff.indexOf(EMERGENCY_PHONE) > 1){
        ...
        if(buff.indexOf("get gps") > 1){
          getGps();
          String sms_data;
          sms_data = "GPS Połozenie pojazdu\r";
...
{
  String sms_data;
  sms_data = "Pwiadomienie o wypadku!!\r";
  sms_data += "http://maps.google.com/maps?q=loc:";
  sms_data += latitude + "," + longitude;
